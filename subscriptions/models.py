...
class Subscription(models.Model):
    ...
    subscription_payment = models.OneToOneField(pymnt_models.Payment, on_delete=models.CASCADE)
...
class SubscriptionPayment(models.Model) :
    parent_payment = models.OneToOneField(pymnt_models.Payment, on_delete=models.CASCADE, related_name="parent_payment_record")
